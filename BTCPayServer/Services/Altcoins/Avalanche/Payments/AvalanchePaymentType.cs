...
{
    public class AvalanchePaymentType: PaymentType
    {
        public static AvalanchePaymentType Instance { get; } = new AvalanchePaymentType();
        public override string ToPrettyString() => "On-Chain";

        public override string GetId()=> "AvalancheLike";


        public override CryptoPaymentData DeserializePaymentData(BTCPayNetworkBase network, string str)
        {
            return JsonConvert.DeserializeObject<AvalancheLikePaymentData>(str);
        }
        ...
        {
            return JsonConvert.DeserializeObject<AvalancheLikeOnChainPaymentMethodDetails>(str);
        }
        ...
        {
            return JsonConvert.DeserializeObject<AvalancheSupportedPaymentMethod>(value.ToString());
        }
        ...
        public override string InvoiceViewPaymentPartialName { get; }= "Avalanche/ViewAvalancheLikePaymentData";
    }
}
#endif
